//------------------------------------------------------------------------------
// <auto-generated>
//     This code was generated by kli.Localize.Tool on 30.03.2020 16:18:09.
//
...
namespace kli.Localize.Test.Localization
{
    ...
    public sealed class InNestedNamespace
    {
        ...
        private class LocalizationProvider
        {
            ...
            {
                var resourceName = $"{typeof(InNestedNamespace).FullName}.json";
                if (cultureInfo != CultureInfo.InvariantCulture)
                    resourceName = resourceName.Replace(".json", $"_{cultureInfo.Name}.json");
                var assembly = typeof(InNestedNamespace).Assembly;
