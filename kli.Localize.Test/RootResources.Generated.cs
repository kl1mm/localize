//------------------------------------------------------------------------------
// <auto-generated>
//     This code was generated by kli.Localize.Tool on 30.03.2020 09:57:22.
//
...
namespace kli.Localize.Test
{
    ...
    public class RootResources
    {
        ...
        private class LocalizationProvider
        {
            ...
            {
                var resourceName = $"{typeof(RootResources).FullName}.json";
                if (cultureInfo != CultureInfo.InvariantCulture)
                    resourceName = resourceName.Replace(".json", $"_{cultureInfo.Name}.json");
                var assembly = typeof(RootResources).Assembly;
