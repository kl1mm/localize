...
namespace kli.Localize.Generator.Internal
{
    internal class LocalizeCodeGeneratorCore
    {
        ...
        private MemberDeclarationSyntax ProjectTranslationToMemberDeclaration(KeyValuePair<string, string> translation)
            => SyntaxFactory.ParseMemberDeclaration($"public static string {translation.Key} => GetString(nameof({translation.Key}), CultureInfo.CurrentUICulture);")
        ...
        private string CreateFileHeader()
        {
            return $@"//------------------------------------------------------------------------------
// <auto-generated>
//     This code was generated by {this.GetType().Assembly.GetName().Name}. at {DateTime.Now}
//
